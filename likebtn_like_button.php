                ...
                <div class="inside">
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" name="likebtn_like_button_account_email" value="<?php echo get_option('likebtn_like_button_account_email') ?>" size="60" onkeyup="accountChange(this)"/>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" name="likebtn_like_button_account_api_key" value="<?php echo get_option('likebtn_like_button_account_api_key') ?>" size="60" onkeyup="accountChange(this)"/>

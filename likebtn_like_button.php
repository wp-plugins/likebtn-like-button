...
function likebtn_like_button_admin_settings() {
    ...
    <div id="poststuff" class="metabox-holder has-right-sidebar">
        <form method="post" action="options.php">
            ...
            <div class="postbox ">
                <h3><?php _e('Votes synchronization', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?> (PRO, VIP, ULTRA)</h3>
                <div class="inside">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row"><label><?php _e('Sync interval', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?></label></th>
                            <td>
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <span class="description"><?php _e('Enter Site ID in following cases:', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN) ?><br/>
                                ...
                                <?php _e('You can find Site ID on your <a href="http://likebtn.com/en/customer.php/websites" target="_blank">Websites</a> page.', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN) ?></span>
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <div id="entity_container_<?php echo $entity_name; ?>" <?php if (!get_option('likebtn_like_button_show_' . $entity_name)): ?>style="display:none"<?php endif ?>>
                            ...
                            <div class="postbox" id="use_settings_from_container_<?php echo $entity_name; ?>" <?php if (get_option('likebtn_like_button_use_settings_from_' . $entity_name)): ?>style="display:none"<?php endif ?>>
                                ...
                                <div class="inside hidden" >
                                    ...
                                    <div class="postbox">
                                        <h3 style="cursor:pointer" onclick="toggleCollapsable(this)" class="likebtn_like_button_collapse_trigger"><small>►</small> <?php _e('Button elements', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?></h3>
                                        <div class="inside hidden">
                                            <table class="form-table">
                                                <tr valign="top">
                                    ...
                                    <div class="postbox">
                                        ...
                                        <div class="inside hidden">
                                            <table class="form-table">
                                                ...
                                                <tr valign="top">
                                                    <th scope="row"><label><?php _e('Repeat vote period', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?></label></th>
                                                    <td>
                                                        ...
                                                        <span class="description">revote_period</span><br/>
                                                        <span class="description"><?php _e('The period of time in seconds after which it is allowed to vote again.', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td>
                                                        <select name="likebtn_like_button_settings_counter_type_<?php echo $entity_name; ?>">
                                                            ...
                                                            <option value="subtract_dislikes" <?php selected('subtract_dislikes', get_option('likebtn_like_button_settings_counter_type_' . $entity_name)); ?> ><?php _e('subtract_dislikes', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?></option>
                                    ...
                                    <div class="postbox">
                                        ...
                                        <div class="inside hidden">
                                            <table class="form-table">
                                                <tr valign="top">
                                                    <th scope="row"><label><?php _e('Show popup after voting', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?> (VIP, ULTRA)</label></th>
                                                    <td>
                                                ...
                                                <tr valign="top">
                                                    <th scope="row"><label><?php _e('Show copyright link in the popup', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?> (VIP, ULTRA)</label></th>
                                                    <td>
                                    ...
                                    <div class="postbox">
                                        <h3 style="cursor:pointer" onclick="toggleCollapsable(this)" class="likebtn_like_button_collapse_trigger"><small>►</small> <?php _e('Events and debugging', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?></h3>
                                        <div class="inside hidden">
                                            <table class="form-table">
                                                <tr valign="top">
                                                    <th scope="row">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="description">info_message</span><br/>
                                                        <span class="description"><?php _e('Show information message when the button is restricted by the tariff plan.', LIKEBTN_LIKE_BUTTON_I18N_DOMAIN); ?></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
